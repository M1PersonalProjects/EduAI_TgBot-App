document.addEventListener('DOMContentLoaded', () => {
  ...
  async function telegramLogin(initData) {
    telegramBlock.hidden = false; standardBlock.hidden = true;
    try {
      ...
      telegramBlock.hidden = true; standardBlock.hidden = false;
  ...
  if (telegram?.initData) { telegram.ready(); telegram.expand(); telegramLogin(telegram.initData); }
});
